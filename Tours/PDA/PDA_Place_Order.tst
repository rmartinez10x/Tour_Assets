  ...
  - $type: RESTClientToolTest
    ...
    tool:
      ...
      literal:
        use: 1
        text:
          MessagingClient_LiteralMessage: "------WebKitFormBoundaryXZoYCOeBAAaEyp2B\r\
            \nContent-Disposition: form-data; name=\"username\"\r\n\r\npurchaser\r\
            \n------WebKitFormBoundaryXZoYCOeBAAaEyp2B\r\nContent-Disposition: form-data;\
            \ name=\"password\"\r\n\r\npassword\r\n------WebKitFormBoundaryXZoYCOeBAAaEyp2B--\r\
            \n"
    ...
    tool:
      ...
      - $type: GenericDataBank
        ...
        wrappedTool:
          ...
          xmlMessage: true
          xmlMessageObj:
            content: 
            editable: true
            headersAvailable: false
            mimeType: true
            mimeTypeObj:
  ...
  - $type: RESTClientToolTest
    ...
    tool:
      ...
      router:
        ...
        fixedValue:
          $type: StringTestValue
          HTTPClient_Endpoint: "${BASEURL}/proxy/v1/cartItems/${Test 19: id}"
      transportProperties:
        manager:
          protocol: 1
          properties:
  ...
  - $type: RESTClientToolTest
    ...
    tool:
      ...
      literal:
        use: 1
        text:
          MessagingClient_LiteralMessage: "{\"itemId\":2,\"itemQty\":1}"
          type: application/json
      mode: Form JSON
      literalQuery:
        isPropertiesRef: true
    ...
    tool:
      ...
      - $type: GenericDataBank
        ...
        wrappedTool:
          ...
          virtualDSCreator:
            writableColumns:
            - customName: "Test 33: locationInfo"
        conversionStrategy:
          dataFormatName: JSON
          conversionStrategyId: JSON
          conversionStrategyClassName: com.parasoft.xml.convert.json.JsonConversionStrategy
  ...
  - $type: RESTClientToolTest
    ...
    tool:
                  ...
                  - $type: ElementValue
                    ...
                    - $type: ComplexValue
                      ...
                      contentValueObj:
                        ...
                        replacedColumn: ""
                        mode: 3
                        columnName: "Test 33: locationInfo"
                        value: ""
                  - $type: ElementValue
                    replacedColumn: ""
                    values:
      ...
      literal:
        use: 1
        text:
          MessagingClient_LiteralMessage: "{\"region\":\"${Test 16: region}\",\"location\"\
            :\"${Test 33: locationInfo}\",\"receiverId\":\"Ra\",\"eventId\":\"111\"\
            ,\"eventNumber\":\"222\"}"
          type: application/json
      mode: Form JSON
      literalQuery:
