...
suite:
  ...
  dataSources:
  - id: ds_1742483909607_1344898169
    impl:
      $type: CSVDataSource
      file: true
      fileObj:
        path: Promp_LLM_generated_data_source.csv
      data: true
      columnNames:
      - categoryName
      - CategoryDescription
  ...
  - $type: TestSuite
    ...
    tests:
    - $type: TestSuite
      name: "Create a category, add an item to it, verify the item, delete the item\
        \ and category, and finally verify the remaining categories."
      testID: 2
      ...
      - $type: RESTClientToolTest
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: "A beautiful sunrise over the mountains, captured\
                              \ in high resolution."
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            $type: StringValue
                            replacedColumn: ""
                            value: /images/sunrise_landscape.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Sunrise Landscape\",\"\
                description\":\"A beautiful sunrise over the mountains, captured in\
                \ high resolution.\",\"imagePath\":\"/images/sunrise_landscape.jpg\"\
                }"
      ...
      - $type: RESTClientToolTest
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: "High-quality Arabica beans roasted to perfection,\
                              \ giving you a rich and aromatic experience."
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            $type: StringValue
                            replacedColumn: ""
                            value: /images/premium_coffee_beans.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Premium Coffee Beans\"\
                ,\"description\":\"High-quality Arabica beans roasted to perfection,\
                \ giving you a rich and aromatic experience.\",\"categoryId\":42,\"\
                inStock\":150,\"imagePath\":\"/images/premium_coffee_beans.jpg\",\"\
