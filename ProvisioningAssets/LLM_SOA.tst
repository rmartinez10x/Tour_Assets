...
suite:
  ...
  notes: |-
    ...
    Timestamp: 2025-04-03 08:27:08
  dataSources:
  - id: ds_1743694466635_1711340936
    impl:
      $type: CSVDataSource
      file: true
      fileObj:
        path: LLM_SOA_generated_data_source.csv
      data: true
      columnNames:
      - categoryName
      - CategoryDescription
  ...
  - $type: TestSuite
    ...
    tests:
    - $type: TestSuite
      name: "This scenario tests the creation and deletion of a category and an item\
        \ within it, verifying each step."
      testID: 2
      ...
      - $type: RESTClientToolTest
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: A reusable water bottle made from biodegradable
                              materials.
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            $type: StringValue
                            replacedColumn: ""
                            value: /images/products/eco-water-bottle.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Eco-Friendly Water Bottle\"\
                ,\"description\":\"A reusable water bottle made from biodegradable\
                \ materials.\",\"imagePath\":\"/images/products/eco-water-bottle.jpg\"\
                }"
      ...
      - $type: RESTClientToolTest
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: "A soft, sustainable t-shirt made from 100% organic\
                              \ cotton."
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            $type: StringValue
                            replacedColumn: ""
                            value: /images/products/organic-cotton-tshirt.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Organic Cotton T-Shirt\"\
                ,\"description\":\"A soft, sustainable t-shirt made from 100% organic\
                \ cotton.\",\"categoryId\":5,\"inStock\":120,\"imagePath\":\"/images/products/organic-cotton-tshirt.jpg\"\
      ...
      - $type: RESTClientToolTest
        ...
        tool:
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: "http://localhost:4040/v1/assets/items/name/{itemName}"
          transportProperties:
            manager:
              protocol: 1
              properties:
