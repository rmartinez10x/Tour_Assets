...
suite:
  ...
  notes: |-
    ...
    Timestamp: 2025-03-17 14:20:52
  dataSources:
  - id: ds_1742247252829_813217708
    impl:
      $type: CSVDataSource
      file: true
      fileObj:
        path: LLM_Integration_Testing_generated_data_source.csv
      data: true
      columnNames:
      - categoryName
      - CategoryDescription
    ...
    useAllRows: true
  - id: ds_1742481743624_647051461
    impl:
      $type: CSVDataSource
      file: true
      fileObj:
        path: LLM_Integration_Testing_generated_data_source_2.csv
      data: true
      columnNames:
      - categoryName
      - CategoryDescription
  ...
  - $type: TestSuite
    ...
    tests:
    - $type: TestSuite
      name: "This scenario creates a new category, adds an item to it, verifies and\
        \ then deletes the item, deletes the category, and finally checks the list\
        \ of categories to ensure deletion."
      testID: 2
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: Cinematic stories capturing human experiences.
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            replacedColumn: ""
                            columnName: CategoryDescription
                            value: /images/sunny_beach_hotel.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          jsonBuilder:
            ...
            value:
              ...
              nameIsNull: true
          schemaURL:
            MessagingClient_SchemaLocation: http://localhost:4040/pda/api-docs/v1
          formInput:
            value:
              $type: ElementValue
              writeType: true
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: http://localhost:4040/v1/assets/categories
          transportProperties:
            manager:
              protocol: 1
              properties:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Sunny Beach Hotel\",\"\
                description\":\"A luxurious hotel located on the sunny coasts offering\
                \ premium amenities and breathtaking ocean views.\",\"imagePath\"\
                :\"/images/sunny_beach_hotel.jpg\"}"
      ...
      - $type: RESTClientToolTest
        ...
        tool:
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            ...
                            value: Vintage poster from a film that made a significant
                              cultural impact.
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                      ...
                      - $type: ElementValue
                        ...
                        - $type: ComplexValue
                          ...
                          contentValueObj:
                            $type: StringValue
                            replacedColumn: ""
                            value: /images/organic_chamomile_tea.jpg
                          compositorValue: true
                          compositorValueObj:
                            replacedColumn: ""
                            values:
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: http://localhost:4040/v1/assets/items
          transportProperties:
            manager:
              protocol: 1
              properties:
          ...
          literal:
            use: 1
            text:
              MessagingClient_LiteralMessage: "{\"name\":\"Organic Chamomile Tea\"\
                ,\"description\":\"A soothing herbal tea made from organically grown\
                \ chamomile flowers, perfect for relaxation.\",\"categoryId\":42,\"\
                inStock\":120,\"imagePath\":\"/images/organic_chamomile_tea.jpg\"\
      ...
      - $type: RESTClientToolTest
        ...
        tool:
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: "http://localhost:4040/v1/assets/items/{itemId}"
          transportProperties:
            manager:
              protocol: 1
              properties:
      ...
      - $type: RESTClientToolTest
        ...
        tool:
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: "http://localhost:4040/v1/assets/categories/{categoryId}"
          transportProperties:
            manager:
              protocol: 1
              properties:
      ...
      - $type: RESTClientToolTest
        ...
        tool:
          ...
          router:
            ...
            fixedValue:
              $type: StringTestValue
              HTTPClient_Endpoint: http://localhost:4040/v1/assets/categories?searchString=&page=0&size=2147483647&sort=%5B%22name%2CASC%22%5D
          urlParameters:
            properties:
